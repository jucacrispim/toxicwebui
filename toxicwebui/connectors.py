...
from toxiccommon.client import get_hole_client
from toxiccore.utils import LoggerMixin
from toxicwebui.utils import get_client_settings
...
class StreamConnector(LoggerMixin):
    ...
    .. code-block:: python
       ...
       from toxicwebui.models import Repository
    ...
    async def _prepare_instance(cls, user, repo_id, events):
        ...
        :class:`toxicwebui.connectors.StreamConnector` that will
        notify about messages from a specific repository.

        :param repo_id: Id of a repository. If repo_id is None, a default
          :attr:`toxicwebui.connectors.StreamConnector` will be used as
          the key.
