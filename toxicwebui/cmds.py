# -*- coding: utf-8 -*-
# Copyright 2023, 2024 Juca Crispim <juca@poraodojuca.net>
...
from toxiccore.utils import bcrypt, changedir, MonkeyPatcher

from toxicwebui import create_settings
    ...
    with changedir(workdir):
        ...
        if conffile:
            ...
            os.environ['TOXICUI_SETTINGS'] = os.path.join(workdir,
                                                          'toxicwebui.conf')
            os.environ['PYROCUMULUS_SETTINGS_MODULE'] = 'toxicwebui'
